...
{
    @Autowired
    private IStudentService1 studentService;
    ...
    @GetMapping("/list")
    public TableDataInfo list(Student1 student)
    {
        startPage();
        List<Student1> list = studentService.selectStudentList(student);
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, Student1 student)
    {
        List<Student1> list = studentService.selectStudentList(student);
        ExcelUtil<Student1> util = new ExcelUtil<Student1>(Student1.class);
    ...
    @PostMapping
    public AjaxResult add(@RequestBody Student1 student)
    {
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody Student1 student)
    {
