<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="课程唯一编号" prop="courseCode">
        <el-input
          v-model="queryParams.courseCode"
          placeholder="请输入课程唯一编号"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="课程全称" prop="courseName">
        <el-input
      ...
      <el-form-item label="总课时数" prop="courseHours">
        <el-input
      ...
      <el-form-item label="是否有效课程" prop="isActive">
        <el-input
          v-model="queryParams.isActive"
          placeholder="请输入是否有效课程"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="courseList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="课程唯一ID" align="center" prop="courseId" />
      <el-table-column label="课程唯一编号" align="center" prop="courseCode" />
      <el-table-column label="课程全称" align="center" prop="courseName" />
      ...
      <el-table-column label="是否有效课程" align="center" prop="isActive" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="开课院系" prop="academy">
          <el-input v-model="form.academy" placeholder="请输入开课院系" />
        </el-form-item>
        <el-form-item label="总课时数" prop="courseHours">
          <el-input v-model="form.courseHours" placeholder="请输入总课时数" />
        </el-form-item>
        <el-form-item label="是否有效课程" prop="isActive">
          <el-input v-model="form.isActive" placeholder="请输入是否有效课程" />
        </el-form-item>
      </el-form>
