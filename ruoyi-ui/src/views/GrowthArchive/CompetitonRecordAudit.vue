  ...
  <div class="app-container">
    ...
    <el-card class="table-container">
      <div slot="header" class="table-header">
        <span class="table-title">科创竞赛审核</span>
      ...
      >
        ...
        <el-table-column label="竞赛级别" align="center" prop="competitionLevel" width="100"/>
...
<script>
import {listAuditCompetition, auditRecord, getAuditCount} from "@/api/student/competition";
...
export default {
  ...
  data() {
    return {
      ...
      historyQueryParams: {
        pageNum: 1,
        pageSize: 10,
        moduleType: 1, // 固定查询科创竞赛类型
        moduleId: null, // 固定查询科创竞赛ID
      },
      // 统计数字
      auditStats: {
        approved: 0,
  ...
  methods: {
    ...
    async showAuditHistory(row) {
      this.historyQueryParams.moduleId = row.competitionId
