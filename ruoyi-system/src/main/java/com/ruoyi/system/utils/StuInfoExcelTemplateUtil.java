...
public class StuInfoExcelTemplateUtil {
    ...
    private void setColumnWidths(Sheet sheet) {
        ...
        sheet.setColumnWidth(3, 20 * 256);  // 录取专业
    ...
    private void createInstructionRows(Sheet sheet, int startRow, CellStyle style) {
        String[] instructions = {
            "填写说明：",
            "1. 以下字段为必填项，不能为空：学生学号、学生姓名、入学年份、录取专业、行政班、分流形式、是否创新班或拔尖班",
            "2. 学生学号：11位数字，如：20250000001",
            "3. 入学年份：4位数字，如：2025",
            "4. 录取专业：必填，如：计算机科学与技术、软件工程、电子信息工程等",
            ...
            "8. 注意：所属书院和系统内专业将根据当前用户自动设置，无需填写"
        };
